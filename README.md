...
* [Hyprtasking](https://github.com/raybbian/hyprtasking) ⭐ 376 | 🐛 28 | 🌐 C++ | 📅 2026-09-09 ![c++][cpp] (Powerful workspace management plugin, packed with features)
...
### [Official plugins](https://github.com/hyprwm/hyprland-plugins) ⭐ 1,453 | 🐛 168 | 🌐 C++ | 📅 2026-09-04

* [border++](https://github.com/hyprwm/hyprland-plugins/tree/main/borders-plus-plus) ⭐ 1,453 | 🐛 168 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Adds one or two additional borders to windows)
* [cs:go vulkan fix](https://github.com/hyprwm/hyprland-plugins/tree/main/csgo-vulkan-fix) ⭐ 1,453 | 🐛 168 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Fixes custom resolutions on CS:GO with -vulkan)
* [hyprbars](https://github.com/hyprwm/hyprland-plugins/tree/main/hyprbars) ⭐ 1,453 | 🐛 168 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Adds title bars to windows)
* [hyprfocus](https://github.com/hyprwm/hyprland-plugins/tree/main/hyprfocus) ⭐ 1,453 | 🐛 168 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp]\(Flashfocus for hyprland)
...
* [hyprlock](https://github.com/hyprwm/hyprlock) ⭐ 1,652 | 🐛 192 | 🌐 C++ | 📅 2026-08-11 ![C++][cpp] (Lock screen)
* [hyprpaper](https://github.com/hyprwm/hyprpaper) ⭐ 1,352 | 🐛 51 | 🌐 C++ | 📅 2026-08-13 ![c++][cpp] (Wallpaper daemon)
...
* [eww](https://github.com/elkowar/eww/) ⭐ 12,669 | 🐛 379 | 🌐 Rust | 📅 2026-07-17 ![rust][rs] (Widget framework built on gtk, that can be used as a statusbar)
* [waybar](https://github.com/Alexays/Waybar/) ⭐ 11,953 | 🐛 742 | 🌐 C++ | 📅 2026-08-27 ![c++][cpp] (Highly customizable Wayland bar for Sway and Wlroots based compositors.)
...
* [ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,459 | 🐛 124 | 🌐 Rust | 📅 2026-09-07 ![rust][rs] (Very customizable bar with gui components)
* [fabric](https://github.com/Fabric-Development/fabric) ⭐ 1,369 | 🐛 7 | 🌐 Python | 📅 2026-09-10 ![python][py] (Fabric is a python widgets framework for wayland and X11 using gtk)
...
* [wayle](https://github.com/wayle-rs/wayle) ⭐ 920 | 🐛 164 | 🌐 Rust | 📅 2026-07-25 ![rust][rs] (A Wayland desktop shell with the bar, notifications, OSD, wallpaper, and device controls built in.)
...
* [Tide-island](https://github.com/enhaoswen/Tide-island) ⭐ 682 | 🐛 4 | 🌐 QML | 📅 2026-09-07 ![c++][cpp] (Lightweight, flexible interactive island for Hyprland)
...
* [mako](https://github.com/emersion/mako) ⭐ 3,252 | 🐛 134 | 🌐 C | 📅 2026-06-30 ![c][c] (Very simple and configurable notification daemon)
* [SwayNotificationCenter](https://github.com/ErikReider/SwayNotificationCenter) ⭐ 2,577 | 🐛 114 | 🌐 Vala | 📅 2026-06-25 ![vala][va] (GNOME like notification daemon, with GUI and all)
...
* [Avizo](https://github.com/misterdanb/avizo) ⭐ 618 | 🐛 22 | 🌐 Vala | 📅 2025-10-08 ![vala][va] (macOS like OSD written in gtk, also comes with nice scripts)
...
* [easyeffects](https://github.com/wwmm/easyeffects) ⭐ 10,189 | 🐛 267 | 🌐 HTML | 📅 2026-09-11 ![c++][cpp] (Limiter, compressor, convolver, equalizer and auto volume and many other plugins for PipeWire applications)
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,382 | 🐛 115 | 🌐 C | 📅 2026-09-06 ![c][c] (A window switcher, application launcher and dmenu replacement)
* [vicinae](https://github.com/vicinaehq/vicinae) ⭐ 9,485 | 🐛 198 | 🌐 C++ | 📅 2026-09-12 ![c++][cpp] (Vicinae is a high-performance, native launcher for your desktop inspired by Raycast)
* [walker](https://github.com/abenz1267/walker) ⭐ 3,040 | 🐛 25 | 🌐 Rust | 📅 2026-07-23 ![rust][rs] (A wayland native, highly customizable and extensible runner)
...
* [mpvpaper](https://github.com/GhostNaN/mpvpaper) ⭐ 1,609 | 🐛 17 | 🌐 C | 📅 2026-08-29 ![c][c] (Wallpaper daemon that wraps MPV, useful for videos, and more advanced usage)
* [Hyprpaper](https://github.com/hyprwm/hyprpaper) ⭐ 1,352 | 🐛 51 | 🌐 C++ | 📅 2026-08-13 ![c++][cpp] (Blazing fast wayland wallpaper utility with IPC controls)
* [waypaper](https://github.com/anufrievroman/waypaper) ⭐ 1,059 | 🐛 15 | 🌐 Python | 📅 2026-08-31 ![python][py] (GUI wallpaper setter)
* [swaybg](https://github.com/swaywm/swaybg) ⭐ 810 | 🐛 14 | 🌐 C | 📅 2026-09-10 ![c][c] (Very simple wallpaper daemon used by default on sway)
* [wpaperd](https://github.com/danyspin97/wpaperd) ⭐ 612 | 🐛 33 | 🌐 Rust | 📅 2026-08-10 ![rust][rs] (Minimal wallpaper daemon for Wayland)
...
* [hyprshade](https://github.com/loqusion/hyprshade) ⭐ 568 | 🐛 7 | 🌐 Python | 📅 2026-06-07 ![python][py] (Frontend to Hyprland's screen shader feature)
...
* [Flameshot](https://github.com/flameshot-org/flameshot) ⭐ 30,837 | 🐛 719 | 🌐 C++ | 📅 2026-09-12 ![c++][cpp] (All in one screenshotting tool with gui, annotation, + more) **(To use make sure you have grim flag enabled)**
* [satty](https://github.com/gabm/satty) ⭐ 2,392 | 🐛 70 | 🌐 Rust | 📅 2026-09-11 ![rust][rs] (A screenshot annotation tool inspired by Swappy and Flameshot)
...
* [hyprmarker](https://github.com/devmobasa/hyprmarker) ⭐ 737 | 🐛 1 | 🌐 Rust | 📅 2026-09-12 ![rust][rs] (ZoomIt-inspired annotation and screenshot tool with drawing, shapes, text, and whiteboard modes)
...
* [nwg-bar](https://github.com/nwg-piotr/nwg-bar) ⭐ 176 | 🐛 6 | 🌐 Go | 📅 2024-08-30 ![go][go] (GTK3-based logout bar)
...
* [hyprlock](https://github.com/hyprwm/hyprlock) ⭐ 1,652 | 🐛 192 | 🌐 C++ | 📅 2026-08-11 ![c++][cpp] (Hyprland's GPU-accelerated screen locking utility)
...
* [SDDM](https://github.com/sddm/sddm) ⭐ 2,348 | 🐛 754 | 🌐 C++ | 📅 2026-08-19 ![c++][cpp]
...
* [Greetd](https://sr.ht/~kennylevinsen/greetd/) ![rust][rs] (Login daemon with a couple greeters, bellow are some good ones)
  * [tuigreet](https://github.com/apognu/tuigreet) ⭐ 1,773 | 🐛 32 | 🌐 Rust | 📅 2026-08-26 ![rust][rs] (Graphical console greeter for greetd)
