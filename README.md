...
### [Official plugins](https://github.com/hyprwm/hyprland-plugins) ⭐ 1,453 | 🐛 167 | 🌐 C++ | 📅 2026-09-04

* [border++](https://github.com/hyprwm/hyprland-plugins/tree/main/borders-plus-plus) ⭐ 1,453 | 🐛 167 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Adds one or two additional borders to windows)
* [cs:go vulkan fix](https://github.com/hyprwm/hyprland-plugins/tree/main/csgo-vulkan-fix) ⭐ 1,453 | 🐛 167 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Fixes custom resolutions on CS:GO with -vulkan)
* [hyprbars](https://github.com/hyprwm/hyprland-plugins/tree/main/hyprbars) ⭐ 1,453 | 🐛 167 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp] (Adds title bars to windows)
* [hyprfocus](https://github.com/hyprwm/hyprland-plugins/tree/main/hyprfocus) ⭐ 1,453 | 🐛 167 | 🌐 C++ | 📅 2026-09-04 ![c++][cpp]\(Flashfocus for hyprland)

### IPC plugins

These technically aren't hyprland plugins, but extend hyprland functionality using only IPC

* [pyprland](https://github.com/hyprland-community/pyprland) ⭐ 705 | 🐛 1 | 🌐 Python | 📅 2026-09-11 ![python][py]
...
* [eww](https://github.com/elkowar/eww/) ⭐ 12,667 | 🐛 379 | 🌐 Rust | 📅 2026-07-17 ![rust][rs] (Widget framework built on gtk, that can be used as a statusbar)
* [waybar](https://github.com/Alexays/Waybar/) ⭐ 11,943 | 🐛 742 | 🌐 C++ | 📅 2026-08-27 ![c++][cpp] (Highly customizable Wayland bar for Sway and Wlroots based compositors.)
...
* [ironbar](https://github.com/JakeStanger/ironbar) ⭐ 1,457 | 🐛 124 | 🌐 Rust | 📅 2026-09-07 ![rust][rs] (Very customizable bar with gui components)
...
* [ashell](https://github.com/MalpenZibo/ashell) ⭐ 1,102 | 🐛 103 | 🌐 Rust | 📅 2026-09-05 ![rust][rs] (A ready to go Wayland status bar for Hyprland)
* [wayle](https://github.com/wayle-rs/wayle) ⭐ 920 | 🐛 163 | 🌐 Rust | 📅 2026-07-25 ![rust][rs] (A Wayland desktop shell with the bar, notifications, OSD, wallpaper, and device controls built in.)
...
* [ignis](https://github.com/linkfrg/ignis) ⭐ 687 | 🐛 67 | 🌐 Python | 📅 2026-09-11 ![python][py] (GTK4-based widget framework for bars and other widgets)
* [Tide-island](https://github.com/enhaoswen/Tide-island) ⭐ 680 | 🐛 4 | 🌐 QML | 📅 2026-09-07 ![c++][cpp] (Lightweight, flexible interactive island for Hyprland)
...
* [SwayOSD](https://github.com/ErikReider/SwayOSD) ⭐ 1,302 | 🐛 33 | 🌐 Rust | 📅 2026-06-22 ![rust][rs] (GNOME like OSD written in gtk)
* [Wob](https://github.com/francma/wob) ⭐ 1,154 | 🐛 15 | 🌐 C | 📅 2026-09-05 ![c][c] (dead simple OSD inspired by xob)
* [Avizo](https://github.com/misterdanb/avizo) ⭐ 618 | 🐛 27 | 🌐 Vala | 📅 2025-10-08 ![vala][va] (macOS like OSD written in gtk, also comes with nice scripts)
...
* [easyeffects](https://github.com/wwmm/easyeffects) ⭐ 10,182 | 🐛 267 | 🌐 HTML | 📅 2026-09-10 ![c++][cpp] (Limiter, compressor, convolver, equalizer and auto volume and many other plugins for PipeWire applications)
...
* [rofi](https://github.com/davatorium/rofi) ⭐ 16,379 | 🐛 115 | 🌐 C | 📅 2026-09-06 ![c][c] (A window switcher, application launcher and dmenu replacement)
* [vicinae](https://github.com/vicinaehq/vicinae) ⭐ 9,474 | 🐛 194 | 🌐 C++ | 📅 2026-09-11 ![c++][cpp] (Vicinae is a high-performance, native launcher for your desktop inspired by Raycast)
* [walker](https://github.com/abenz1267/walker) ⭐ 3,038 | 🐛 25 | 🌐 Rust | 📅 2026-07-23 ![rust][rs] (A wayland native, highly customizable and extensible runner)
...
* [mpvpaper](https://github.com/GhostNaN/mpvpaper) ⭐ 1,606 | 🐛 17 | 🌐 C | 📅 2026-08-29 ![c][c] (Wallpaper daemon that wraps MPV, useful for videos, and more advanced usage)
...
* [Flameshot](https://github.com/flameshot-org/flameshot) ⭐ 30,832 | 🐛 721 | 🌐 C++ | 📅 2026-09-11 ![c++][cpp] (All in one screenshotting tool with gui, annotation, + more) **(To use make sure you have grim flag enabled)**
* [satty](https://github.com/gabm/satty) ⭐ 2,390 | 🐛 70 | 🌐 Rust | 📅 2026-09-11 ![rust][rs] (A screenshot annotation tool inspired by Swappy and Flameshot)
...
* [hyprmarker](https://github.com/devmobasa/hyprmarker) ⭐ 735 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 ![rust][rs] (ZoomIt-inspired annotation and screenshot tool with drawing, shapes, text, and whiteboard modes)
...
* [hyprlock](https://github.com/hyprwm/hyprlock) ⭐ 1,651 | 🐛 192 | 🌐 C++ | 📅 2026-08-11 ![c++][cpp] (Hyprland's GPU-accelerated screen locking utility)
...
* [Greetd](https://sr.ht/~kennylevinsen/greetd/) ![rust][rs] (Login daemon with a couple greeters, bellow are some good ones)
  * [tuigreet](https://github.com/apognu/tuigreet) ⭐ 1,772 | 🐛 28 | 🌐 Rust | 📅 2026-08-26 ![rust][rs] (Graphical console greeter for greetd)
